...
const BountyInformationDetails2Content = () => {
  return (
    <div className="bg-[#272D37] p-10 rounded-3xl overflow-hidden">
      <div className="grid grid-cols-[210px,auto,180px]">
        <div>
          ...
          <div className="rounded-[18px] overflow-hidden mt-1 mb-2">
            <Image {...placeholderImage} className="aspect-square" />
          </div>
          <p className="text-sm font-medium text-center">Status: claimed </p>
        </div>
        <div className="ml-[60px] mt-[100px]">
          <h3 className="__title_lg"> Details</h3>
          <div className="space-y-4 mt-14">
            <div className="grid grid-cols-[150px,auto] gap-2">
              <div className="__gray_box">Bounty hunter</div>
              <p className="flex items-center font-semibold capitalize">
                Adfd…..Dsad
              </p>
            </div>
            <div className="grid grid-cols-[150px,auto] gap-2">
              <div className="__gray_box">Projects completed</div>
              <p className="flex items-center font-semibold capitalize">
                March 4th 2023
              </p>
            </div>
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <button className="w-full px-3 __btn py-2.5">Go Back</button>
            <button className="w-full px-3 __btn py-2.5">End Project</button>
          </div>
        </div>
...
export default BountyInformationDetails2Content;
